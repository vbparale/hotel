        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <a href="<?= base_url('frontdesk/guest_details/'.$guest->guest_id); ?>"><?= $guest->firstname ?> <?= $guest->lastname ?></a> </td>
          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="widget">
              ...
              <div class="widget-content">
                <div class="shortcuts">
                  <a href="<?= base_url('frontdesk/rooms'); ?>" class="shortcut"><i class="shortcut-icon icon-home"></i><span class="shortcut-label">Rooms</span> </a>
                  <a href="<?= base_url('frontdesk/guests'); ?>" class="shortcut"><i class="shortcut-icon icon-user"></i><span class="shortcut-label">Guests</span> </a>
                  <a href="<?= base_url('frontdesk/status'); ?>" class="shortcut"><i class="shortcut-icon icon-info"></i><span class="shortcut-label">Unpaid Guests</span> </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <span><button type="submit" class="btn btn-primary pull-right" onclick="add_banned_cutomer_modal()">Add Banned Guest</button>
          <h3>Banned Customer</h3></span>
        </div>
        <div class="modal-body">
          <div class="col-md-12" id="banned_data">
          </div>
        </div>
...
var base_url =  '<?php echo base_url() ?>';
 $(document).ready(function() {
  ...
  $('#banned_customer_modal').modal('show');
   var url = base_url + "frontdesk/get_all_banned_customer";
        ...
        if(data.banned_customer){
          $.each(data.banned_customer, function (key, value) {
            $('#banned_data').append(
              ...
              '<img src="'+base_url+'assets/img/thumbnails/'+value.photo+'" class="img-responsive" style=" right: 0; bottom: 0; width: 100px;" alt="">'+
              '</div>'+
              '<div class="form-group">'+
              '<label for="Name">'+value.firstname+' '+value.lastname+' </label>'+
              '</div>'+
              '</div>'+
              '</div>'+
              '</div>'
