        ...
        <div class="" style="padding: 30px;">
          <div class="col-lg-12 col-md-12">
            <a role="button" data-toggle="modal" href="#add_rooms" class="btn btn-sm btn-primary"><i class="btn-icon-only icon-plus"></i>Add Room</a>
             <a role="button" data-toggle="modal" href="#bulk_room_data" class="btn btn-sm btn-default"><i class="btn-icon-only icon-plus"></i>Bulk Room</a>
          <br><br>
              ...
              <div class="tab-content">
                    ...
                    <div class="modal fade" id="checkout_confirm<?= $room->service_id ?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <form action="<?=base_url('admin/checkout')?>" method="post" role="form">
                ...
                <div id="available" class="tab-pane fade">
                 ...
                 <!-- Edit Room Modal -->
                  <div class="modal fade" id="edit_room<?= $aroom->room_id ?>" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal">×</button>
                              ...
                              <div class="" style="margin: 10px; ">
                                <a  href="<?= base_url('admin/remove_room/'.$aroom->room_id); ?>" class="btn btn-block btn-xs btn-danger"><i class="icon-remove"></i> Remove Room</a>
                              </div>

                              <form action="<?=base_url('admin/edit_room')?>" method="post" role="form">
                                  <div class="modal-body">
                                      <input type="hidden" class="form-control" id="room_id" name="room_id" value="<?= $aroom->room_id ?>">
                                      <div class="form-group">
                                          <label for="room_name">Room Name</label>
                                          <input type="text" class="form-control" id="room_name" name="room_name" value="<?= $aroom->room_name ?>" required>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="rate" name="rate" value="<?= $aroom->rate ?>" required>
                                      </div>
                                      <div class="form-group">
                                          <label for="floor">Floor </label>
                                          <input type="text" class="form-control" id="floor" name="floor" value="<?= $aroom->floor ?>">
                                      </div>
...
$(document).on("click", "#view_room_btn", function () {
   ...
   //$("#occ_tab").hide();
    ...
    var url = base_url + "admin/view_available_rooms/"+checkin+"/"+checkout+"/"+room_type;
    console.log(url);
