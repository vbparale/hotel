  ...
  <div style="margin-bottom: 30px; margin-left: 230px;">
    ...
    <a role="button" data-toggle="modal" href="#checkin" class="btn btn-primary btn-sm"><i class="btn-icon-only icon-plus"></i> Reservation</a>
  </div>
