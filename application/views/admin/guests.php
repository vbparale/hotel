  ...
  <div class="main-inner">
    <div class="container">
      <div class="row">
        ...
        <a role="button" data-toggle="modal" href="#bulk_checkin_data" class="btn btn-sm btn-default pull-right"><i class="btn-icon-only icon-plus"></i> Bulk Checkin</a>
        <a role="button" data-toggle="modal" href="#bulk_user_data" class="btn btn-sm btn-default pull-right"><i class="btn-icon-only icon-plus"></i> Bulk Guest</a>
           <a role="button" data-toggle="modal" href="#bulk_payment_data" class="btn btn-sm btn-default pull-right"><i class="btn-icon-only icon-plus"></i> Bulk Payment</a>
